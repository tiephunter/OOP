...
public class form3 extends javax.swing.JFrame {
    ...
    public void Setdata(ArrayList<NhanVien> list){
        ...
        model3.addColumn("He sl");
        model3.addColumn("Than nien");
        model3.addColumn("Luong coban ");
        model3.addColumn("Luong thuc Linh");
        for (NhanVien nv : list) {
            Object[] rowdata = { nv.Hoten, nv.NgaySinh, nv.GioiTinh, nv.getPhongBan(), nv.getHSL(), nv.getThamnien(), nv.getLuongCB(), nv.LUONGTHuclinh()      
            };
