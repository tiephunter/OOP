                        ...
                        btnChat.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                try {
                                    ...
                                    int AmoutFriends = in.readInt();
                                    for (int i = 0; i < AmoutFriends; i++) {
                                            ...
                                            public void actionPerformed(ActionEvent e) {
                                                try {
                                                    ...
                                                    if (success == CHAT_ACTION_SUCESS) {
                                                        ...
                                                        frameConverstation.setLocationRelativeTo(frameChat);
                                                        ...
                                                        //create panelConverstation
                                                        JPanel panelConverstation = new JPanel()  ;
                                                        BoxLayout boxLayOutConver = new BoxLayout(panelConverstation, 1);
                                                        panelConverstation.setLayout(boxLayOutConver);
                                                        panelConverstation.setBorder(new EmptyBorder(0, 50, 0, 50));
                                                        panelConverstation.setBackground(Color.orange);
                                                        ...
                                                        JTextField tfInputMessage = new JTextField("",JTextField.LEFT);
                                                        ...
                                                        btnSend.addActionListener(new ActionListener() {
                                                            ...
                                                            public void actionPerformed(ActionEvent e) {
                                                                try {
                                                                    ...
                                                                    if (Message == RECIVED_MESSENGER_SUCCESS ) {
                                                                        int idMsg = in.readInt();
                                                                        int idSession = in.readInt();
                                                                        int idUser = in.readInt();
                                                                        String tfInputMsg = in.readUTF();
                                                                        JLabel lbMsgNow = new JLabel(tfInputMsg, JLabel.RIGHT);
                                                                        lbMsgNow.setHorizontalAlignment(SwingConstants.RIGHT);
                                                                        tfInputMessage.setText("");
                                                                        panelConverstation.add(lbMsgNow);
                                                                        panelConverstation.updateUI();
                                                                    }
                                                                    else{
                                                        ...
                                                        JScrollPane spChat = new JScrollPane(panelConverstation, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, 
                        ...
                        btnSearch.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                try {
                                    ...
                                    out.flush();
                                    int AmoutUser = in.readInt();
                                    System.out.println("Amout user " + AmoutUser);
                                    for (int i = 0; i < AmoutUser; i++) {
                                        ...
                                        String TenTaiKhoanFriend = in.readUTF();
                                        //create label
                                        JLabel lableNameFriends = new JLabel(TenTaiKhoanFriend, JLabel.CENTER);
                                        lableNameFriends.setSize(20, 20);
                                        //set lable
                                        ...
                                        panelHome.add(lableNameFriends);
